...
function a(t)
{
  switch(t.tagName)
  {
    case"LINK":return t.getAttribute("href");
    case"OBJECT":var n=t.getAttribute("data");
    if(n)return n;
    for(var r=t.getElementsByTagName("PARAM"),a=0;a<r.length;a++)
    {
      var e=r[a];
      if(/^src$|^movie$/i.test(e.name))return e.value
    }
    return null;
    default:return t.getAttribute("src")
  }
}
function e(t)
{
  ...
  if(!n)return null;
  var r=n[1];
  return f.test(r)&&(r=r.split("@").pop().split(":")[0]),r
}
function o(t)
{
  return l.test(t)
...
var i=window.atob,c=
{
  69:"LnRic2JfYmdfZGl2LCN0YnNiLW5vdGlmaWVycw==",7:"I3lvdWRhb0dXWlMxMSwjaHVpLXBsdWdpbjExLCN5b3VkYW9HV1pTLXNpZGViYXItcmlnaHQ=",21:"LnRiLWtleSBkaXZbc3R5bGU9Im1hcmdpbi10b3A6MTBweDttYXJnaW4tYm90dG9tOjVweCJdIC5mbA=="
}
,u=
{
};
...
function a(t)
{
  for(var n=0,r=0,a=t.length;r<a;r++)n=(n<<5)-n+t.charCodeAt(r),n>>>=0;
  return n
}
function e(t)
{
  ...
  if(r.tagName in m)
  {
    ...
    if(i)
    {
      ...
      if(c)
      {
        c=t.GetRootDomain(c);
        var u=s[c];
        u||(u=s[c]=a(c)),u in n&&(l[c]=!0,e(r),o.log(d))
      }
    }
  }
}
...
function f()
{
  ...
  {
    var t="__blkset__";
    l=document[t],l||(l=document[t]=
    {
    }
    ,l.__raw=n),u()
  }
}
var l,v=window.MutationObserver,d=10,m=
{
  SCRIPT:1,IMG:1,LINK:1,IFRAME:1
}
,s=
{
};
