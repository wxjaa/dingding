!
    function(e) {
        ...
        //{default:{OK:true}}
            ...
            console.log(r);
        if (r["default"].OK) {
            c["default"].render(c["default"].createElement(l["default"], {
            ...
            var u = [
                {
                name: "Chrome",
                icon: "https://img.alicdn.com/tps/TB1ZljFIFXXXXbcXpXXXXXXXXXX.png",
                home: "https://www.google.com/chrome/"
            }, {
                name: "Safari",
                icon: "https://img.alicdn.com/tps/TB1uZLpIFXXXXXwaXXXXXXXXXXX.png",
                home: "https://www.apple.com/cn/safari/"
            }, {
                name: "Firefox",
                icon: "https://img.alicdn.com/tps/TB1h7rwIFXXXXcmXFXXXXXXXXXX.png",
                home: "https://www.mozilla.org/zh-CN/firefox/new/"
            }, {
                name: "Internet Explorer 11",
                icon: "https://img.alicdn.com/tps/TB1RfnFIFXXXXbKXpXXXXXXXXXX.png",
                home: "http://windows.microsoft.com/zh-cn/internet-explorer/ie-11-worldwide-languages"
            }];
        ...
        t.OK = a
            ...
            //2  /生成.wf-wrapper  div  调用 3->16->17 (调用生成每个组件的方法)
        function(e, t, n) {
        "use strict";
        ...
        var i = function() {
            ...
            X = function(e) {
                function t(e) {
                    ...
                    this.state = {
                        ready: this.form.isReady && o.getItems().length > 0,
                        published: this.form.isPublished(),
                        isAlimail: "alimail" == window.__group__
                ...
                return r(t, e), i(t, [
                    ...
                    value: function() {
                        ...
                        return c["default"].createElement("div", {
                            ...
                            className: "navbar-single-logo",
                            src: "//img.alicdn.com/tps/TB1TCo4LVXXXXb3aXXXXXXXXXXX-32-32.png",
                            alt: "返回审批管理",
                            ...
                            src: "//gtms01.alicdn.com/tps/i1/TB17dLlLXXXXXXAXVXX4e0PNFXX-336-78.png",
                            alt: "返回审批管理"
                        })), c["default"].createElement("span", {
                            className: "navbar-head"
                        }, "设计器")), c["default"].createElement("div", {
                            className: "head-actions" + (this.state.ready ? "" : " disabled")
                        }, this.state.isAlimail ? null : c["default"].createElement("button", {
                            className: "wf-button wf-button-green",
                            onClick: function() {
                                return e.form.preview()
                            }
                        }, "预览"), this.state.published ? null : c["default"].createElement("button", {
                            className: "wf-button wf-button-cyan",
                            onClick: function() {
                                return e.form.save()
                            }
                        }, "保存"), c["default"].createElement("button", {
                            className: "wf-button wf-button-blue",
                            onClick: function() {
                                return e.form.save(1)
                            }
        ...
        var l = function() {
            ...
            _ = function(e) {
                function t(e) {
                    var n = this;
                    return r(this, t), s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this.props = {}, this.params = d.getParams(e) || {}, this.container = new C["default"]([], this), this.activeComponent = null, this.hoverComponent = null, this.params.formUuid ? (y["default"].loading("数据加载中"), w["default"].getData(this.params.formUuid).done(function(e) {
                        var t = {},
                            o = void 0,
                            a = void 0;
                        try {
                            t = f["default"].parseJSON(e.data.content) || {}, o = e.data.condition[0], a = e.data.ruleType, e.data.isAttendanceCorp && (window.isAttendanceCorp = e.data.isAttendanceCorp)
                        } catch (r) {}["title", "icon", "description"].forEach(function(e) {
                            n.props[e] = t[e] || ""
                ...
                return i(t, e), l(t,
                    ...
                    key: "setProps",
                    value: function(e) {
                        this.props = f["default"].extend({}, e), this.emit("propschange"), this.check()
                    }
                }, {
                    key: "getItems",
                    value: function() {
                    ...
                    key: "toJSON",
                    value: function() {
                        var e = f["default"].extend({}, this.props);
                    ...
                    value: function(e) {
                        var t = this,
                            n = window.location.href.indexOf("procType=outer") > -1;
                        ...
                        w["default"].getCondition(this.params.formUuid).then(function(n) {
                            ...
                            if (o) {
                                ...
                                var r = t.container.getItems(),
                                    l = r.find ? r.find(function(e) {
                            ...
                            var c = {
                                isCopyPublic: t.params.formUuid && "true" === t.params.isCopyPublic ? "true" : "false",
                                formVo: JSON.stringify(i),
                                processCode: t.params.processCode,
                                isPublishProcess: e ? "true" : "false"
                            };
        ...
        var l = function() {
            ...
            g = function() {
                ...
                return l(e, [{
                    ...
                    key: "move",
                    value: function(e) {
                        var t = e.clientX - this.startEvent.clientX,
                            n = e.clientY - this.startEvent.clientY;
        ...
        var w = function() {
            ...
            return l(e, [{
                ...
                value: function(e, t, n) {
                    ...
                    if (!o) return !1;
                    var a = c["default"](o).find(".dropbody")[0],
        ...
        var i = function() {
                ...
                return r(t, e), i(t, [{
                    ...
                    value: function() {
                        ...
                        return t.width = this.props.width, c["default"].createElement("div", {
                            className: "wf-popup " + (this.props.className || ""),
                            style: t
                        }, c["default"].createElement("i", {
                            className: "icon icon-close wf-popup-close",
                            onClick: w.clear
                        }), this.props.children)
                    }
                }]), t
                ...
                return r(t, e), i(t, [{
                    ...
                    value: function() {
                        ...
                        return c["default"].createElement(v, {
                            ...
                            className: "wf-button wf-button-white",
                            onClick: w.clear
                        }, "取消"))))
                    }
                }]), t
            ...
            w = {
                save: function(e, t) {
                    w.clear();
                    var n = p["default"].extend({}, e.getProps());
                    c["default"].render(c["default"].createElement(v, {
                        ...
                        className: "wf-button wf-button-" + (t ? "blue" : "cyan"),
                        onClick: function() {
                            return e.save(t)
                        }
                ...
                removeConfirm: function(e) {
                    c["default"].render(c["default"].createElement(y, {
                        callback: e,
                        title: "你确定要删除该组件吗？",
                        message: "删除后该组件对应的数据也会删除，建议先导出数据备份。如需保留数据，请尽量沿用原组件。"
                    }), w.getBoard(!0))
                },
                ...
                pushCanlendarConfirm: function(e) {
                    c["default"].render(c["default"].createElement(y, {
                        callback: e,
                        title: "你确认要替换吗？",
                        message: "每个审批只能有一个时间区间设置为员工状态，当前审批已开启员工状态设置。"
                    }), w.getBoard(!0))
                },
                getBoard: function(e) {
                    if (!w.board) {
        ...
        var i = function(e, t, n) {
            ...
            m = [
                {
                name: "cooperation",
                value: "//gw.alicdn.com/tps/TB1x_APNXXXXXaoXFXXXXXXXXXX-68-68.png"
            }, {
                name: "contract",
                value: "//gw.alicdn.com/tps/TB1AlISNXXXXXXqXFXXXXXXXXXX-68-68.png"
            }, {
                name: "promote",
                value: "//gw.alicdn.com/tps/TB1vhIMNXXXXXcoXFXXXXXXXXXX-68-68.png"
            }, {
                name: "payment",
                value: "//gw.alicdn.com/tps/TB1t33BNXXXXXanaXXXXXXXXXXX-68-68.png"
            }, {
                name: "maintenance",
                value: "//gw.alicdn.com/tps/TB1e5wBNXXXXXXJaXXXXXXXXXXX-68-68.png"
            }, {
                name: "procurement",
                value: "//gw.alicdn.com/tps/TB1z8kQNXXXXXX4XFXXXXXXXXXX-68-68.png"
            }],
            h = function(e) {
                function t() {
                    a(this, t), null != e && e.apply(this, arguments)
                ...
                return r(t, e), l(t, [{
                    ...
                    value: function() {
                        ...
                        return console.log("selected:" + this.props.selected), c["default"].createElement("label", {
                            className: "iconitem" + (this.props.selected ? " selected" : ""),
                            onClick: function() {
            ...
            v = function(e) {
                ...
                return r(t, e), l(t, [{
                    ...
                    value: function() {
                        var e = this,
                            t = window.location.href.indexOf("procType=outer") > -1;
                        ...
                        return c["default"].createElement("div", {
                            ...
                            return c["default"].createElement(h, {
                                ...
                                name: t.name,
                                src: t.value,
                                selected: e.props.value == t.name,
                                onSelect: e.props.onChange
                            })
                        }))
                    }
                }]), t
            ...
            g = function(e) {
                function t(e) {
                    ...
                    a(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e), this.form = this.props.form, this.state = {
                        props: this.form.getProps(),
                        validstatus: this.form.getValidStatus()
                    };
                    var o = function() {
                ...
                return r(t, e), l(t, [{
                    ...
                    value: function() {
                        var e = this,
                            t = "",
                            n = "",
                            o = "最多" + f["default"].TITLE_WORD_LIMIT + "个字";
                        ...
                        var a = window.location.href.indexOf("procType=outer") > -1,
                            r = !this.state.props.icon && a ? "cooperation" : "common";
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            DESC_WORD_LIMIT: 100,
            LABEL_WORD_LIMIT: 10,
            ACTION_WORD_LIMIT: 10,
            PLACEHOLDER_WORD_LIMIT: 20,
            UNIT_WORD_LIMIT: 20,
            TEXTNOT_CONTENT_LIMIT: 5e3,
            MAX_OPTIONS: 200
        }, e.exports = t["default"]
    },
        //13  网络请求方法
        ...
        var a = n(5),
            ...
            l = (o(i), n(6)),
            s = {
                readUrl: "/" + window.__group__ + "/web/query/form/getForm",
                getConditionUrl: "/" + window.__group__ + "/web/query/form/getFormRuleCondition",
                saveUrl: "/" + window.__group__ + "/web/query/form/saveFormAndProcess",
                savePreviewUrl: "/" + window.__group__ + "/web/query/form/savePreviewForm",
                checkForRemove: "/" + window.__group__ + "/web/query/form/checkFormComponentCanDelete"
            },
            c = {
                getDataUrl: function() {
                ...
                checkForRemove: function(e, t) {
                    ...
                    return r["default"].ajax({
                        url: this.getDataUrl() + s.checkForRemove + ".json",
                        data: n,
                        type: window.isMock ? "get" : "post",
                        dataType: "json"
                    })
                },
                getData: function(e) {
                ...
                save: function(e) {
                    ...
                    return t && t.procType && t.procType.length > 0 && (e.procType = t.procType), r["default"].ajax({
                        url: this.getDataUrl() + s.saveUrl + ".json",
                        data: e,
                        type: window.isMock ? "get" : "post",
                        dataType: "json"
                    })
                ...
                preview: function(e) {
                    var t = l.getParams(window.location.href);
                    return t && t.procType && t.procType.length > 0 && (e.procType = t.procType), r["default"].ajax({
                        url: this.getDataUrl() + s.savePreviewUrl + ".json",
                        data: e,
                        type: window.isMock ? "get" : "post",
                        dataType: "json"
                    })
        ...
        var l = function() {
            ...
            b = function(e) {
                function t(e, n, o) {
                    a(this, t), s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this.validators = [], this.form = e, this.schema = n || {}, this.props = f["default"].extend(!0, {}, this.schema.props || this.getDefaultProps()), this.id = i(this.props.id, this.getComponentName()), this.container = o, this.validstatus = {}, this.published = this.form.isPublished(), this.init()
                }
                return r(t, e), l(t, [{
                    key: "init",
                    value: function() {}
                    ...
                    value: function(e) {
                        for (var t = this.validators.filter(function(t) {
                            return t.prop === e
                        }), n = void 0, o = 0, a = t.length; a > o; o++) if (n = t[o], n.validator.call(this, this.getProp(n.prop)) === !0) return n.type;
                        return null
                    }
                }, {
                    key: "valid",
                    value: function() {
                        for (var e = this.validators, t = void 0, n = 0, o = e.length; o > n; n++) if (t = e[n], t.validator.call(this, this.getProp(t.prop)) === !0) return {
                            msg: t.msg,
                            component: this
                        };
                        return null
                    ...
                    value: function() {
                        ...
                        this.intoView = !1;
                        var e = this.getBoundaryNode().getBoundingClientRect(),
                            t = this.form.getBoundaryNode().firstChild,
                    ...
                    key: "uniqueLabel",
                    value: function() {
                        for (var e = this.props.label ?
                            function(e) {
                                var t = /^(.*)\(\d+\)$/.exec(e);
                                return t ? t[1] : e
                            }(this.props.label) : this.getDefaultLabel(), t = 1, n = e; this.container.existsLabel(this.stringifyLabel(n), this);) t += 1, n = e + "(" + t + ")";
                        return n
                    }
                }, {
                    key: "getDefaultLabel",
        ...
        var w = function(e) {
            function t(e) {
                ...
                a(this, t), s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e), this.component = this.props.component, this.state = {
                    props: this.component.getProps(),
                    active: this.component.isActive(),
                    draging: 0,
                    hover: 0,
                    areaactive: 0
                };
            ...
            return r(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = this.component.getForm().getDragService(),
                        n = f["default"](u["default"].findDOMNode(this)),
                        o = n.children(".wf-overlay");
                ...
                value: function(e) {
                    ...
                    if (t.component.isPublished()) {
                        var n = t.component.getForm().getId(),
                            o = t.component.getId();
      ...
      //17
                ...
                return r(t, e), l(t, [{
                    ...
                    value: function() {
                        for (var e = this.props.label ? this.props.label.map(function(e) {
                            var t = /^(.*)\(\d+\)$/.exec(e);
                            return t ? t[1] : e
                        }) : this.getDefaultLabel(), t = 1, n = e; this.container.existsLabel(this.stringifyLabel(n), this);) t += 1, n = e.map(function(e) {
                            return e + t
                        });
                        return n
                    }
        ...
        var i = function() {
                ...
                return r(t, e), i(t, [{
                    ...
                    value: function() {
                        var e = this.state.props,
                            t = e.statField || [],
                            n = [],
                            o = this.state.items.map(function(e) {
                                if (!e) return null;
                                var o = e.getComponentView(),
                                    a = e.getId();
                        ...
                        n = n.map(function(e) {
                            var t = "MoneyField" === e.getComponentName() && "1" != e.getProp("notUpper"),
                                n = e.getProp("durationLabel") || e.getProp("label"),
                                o = e.getProp("unit");
                        ...
                        var a = c.wordcut(e.label || "", v["default"].LABEL_WORD_LIMIT),
                            r = c.wordcut(e.actionName || "增加" + a, v["default"].ACTION_WORD_LIMIT);
                        return React.createElement("div", {
                            className: "wf-componentview"
                        }, React.createElement("label", {
                            className: "wf-componentview-label"
            ...
            X = function(e) {
                ...
                return r(t, e), i(t, [{
                    ...
                    key: "toJSON",
                    value: function() {
                        var e = l(Object.getPrototypeOf(t.prototype), "toJSON", this).call(this),
                            n = this.getProp("statField") || [],
                            o = [];
                        return e.children = this.tableContainer.getItems().map(function(e) {
                            var t = e.getId();
                            return n.indexOf(t) > -1 && o.push({
                                id: t,
                                label: e.getProp("durationLabel") || e.getProp("label"),
                                unit: e.getProp("unit"),
                                upper: "MoneyField" === e.getComponentName() && "1" != e.getProp("notUpper")
                            }), e.toJSON()
                    ...
                    value: function() {
                        ...
                        return e ? e : this.tableContainer.getItems().length < 1 ? {
                            msg: "请添加组件到" + (this.props.label || "明细组件") + "中",
                            component: this
        ...
        var m = function(e) {
            ...
            return r(t, e), i(t, [{
                ...
                value: function() {
                    var e = this,
                        t = this.form.getDragService(),
                        n = c["default"](p["default"].findDOMNode(this)),
                        o = function(n) {
                            t.start(n, e.item)
                        };
        ...
        var i = function() {
                ...
                return r(t, e), i(t, [{
                    ...
                    value: function() {
                        return c["default"].createElement("div", {
                            ...
                            className: "tabitem" + ("form" !== this.props.current ? " current" : "")
            ...
            X = function(e) {
                function t(e) {
                    ...
                    a(this, t), l(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e), this.state = {
                        currentTab: "form",
                        component: this.props.form.currentComponent
                    }, this.props.form.on("activechange", function(e) {
                        n.setState({
                            currentTab: e ? "component" : "form",
                            component: e
                        })
                    })
                }
                return r(t, e), i(t, [{
                    ...
                    value: function() {
                        ...
                        return e = "component" === this.state.currentTab ? this.state.component ? c["default"].createElement(g, {
                            ...
                            tabWillChange: this.tabWillChange.bind(this)
                        }), e)
                    }
                }]), t
            }(c["default"].Component);
            ...
            X = function(e) {
                ...
                return a(t, e), l(t, [{
                    ...
                    value: function() {
                        var e = this,
                            t = "",
                            n = "最多" + f["default"].LABEL_WORD_LIMIT + "个字";
                        return "duplicate" === this.state.validstatus ? (t = "error-duplicate", n = "标题冲突") : "empty" === this.state.validstatus ? (t = "error-empty", n = "标题不能为空") : "toolong" === this.state.validstatus && (t = "error-toolong"), React.createElement("div", {
                            ...
                            type: "text",
                            className: t,
                            defaultValue: this.props.component.getProp(this.label),
                            onChange: function(t) {
        ...
        var y = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = "",
                        n = "最多" + f["default"].PLACEHOLDER_WORD_LIMIT + "个字";
                    return "toolong" === this.state.validstatus && (t = "error-toolong"), React.createElement("div", {
                        ...
                        type: "text",
                        className: t,
                        defaultValue: this.props.component.getProp("placeholder"),
                        onChange: function(t) {
        ...
        var b = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = "",
                        n = "最多" + f["default"].UNIT_WORD_LIMIT + "个字";
                    return "toolong" === this.state.validstatus && (t = "error-toolong"), React.createElement("div", {
                        className: "wf-field wf-setting-placeholder"
                    }, React.createElement("div", {
                        className: "fieldname"
                        ...
                        type: "text",
                        className: t,
                        defaultValue: this.props.component.getProp("unit"),
                        onChange: function(t) {
        ...
        var w = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = "",
                        n = "最多" + f["default"].TEXTNOT_CONTENT_LIMIT + "个字";
                    return "empty" === this.state.validstatus ? (t = "error-empty", n = "说明文字不能为空") : "toolong" === this.state.validstatus && (t = "error-toolong"), React.createElement("div", {
                        ...
                        type: "text",
                        defaultValue: this.props.component.getProp("content"),
                        onChange: function(t) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        type: "text",
                        defaultValue: this.props.component.getProp("link"),
                        onChange: function(t) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        type: "checkbox",
                        value: "1",
                        defaultChecked: this.props.component.getProp("hiddenInApprovalDetail"),
                        onChange: function(t) {
        ...
        var O = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this.props.component,
                        t = e.inTableField(),
                        n = 1 === this.props.component.isForCondition() && !t;
                    return React.createElement("div", {
                        ...
                        value: "1",
                        disabled: n,
                        defaultChecked: e.getProp("required"),
                        onChange: function(t) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        type: "checkbox",
                        value: "1",
                        defaultChecked: e.getProp("pushToAttendance"),
                        onChange: function(t) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        type: "checkbox",
                        value: "1",
                        defaultChecked: "1" === this.props.component.getProp("notPrint") ? !1 : !0,
                        onChange: function(t) {
        ...
        var _ = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                key: "render",
                value: function() {
                    var e = this.props.component.inTableField(),
                        t = 1 === this.props.component.isForCondition() && !e;
        ...
        var P = function(e) {
            function t(e) {
                ...
                var o = this.props.component.props.push,
                    a = this.props.component.getProp("pushToCalendar");
                if (!o && a ? (o = {}, o.pushSwitch = a) : a || o ? !a && o ? this.props.component.setProp("pushToCalendar", o.pushSwitch ? o.pushSwitch : "0") : o && a && this.props.component.setProp("pushToCalendar", o.pushSwitch) : this.props.component.setProp("pushToCalendar", "0"), (!o || !o.pushTag || "" === o.pushTag) && window.__FormTitle__) {
                    var l = window.__FormTitle__.length > 5 ? window.__FormTitle__.substring(0, 5) : window.__FormTitle__,
                        s = this.getPushProps();
                ...
                this.state = {
                    pushSwitch: o && o.pushSwitch && o.pushSwitch === h,
                    isAttendanceCorp: o && c && c === h
                };
                var u = function() {
                    ...
                    n.setState({
                        pushSwitch: e.pushSwitch ? e.pushSwitch === h : !1,
                        isAttendanceCorp: t ? t === h : !1
                    })
                };
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        className: "wf-tips",
                        src: "https://gw.alicdn.com/tps/TB1b8LwKFXXXXaRXFXXXXXXXXXX-200-200.png",
                        onClick: function(t) {
                            e.showGuide()
                        }
                    }))), React.createElement("label", {
                        ...
                        className: "wf-icon",
                        id: "attendanceIcon",
                        src: this.state.isAttendanceCorp ? "https://gw.alicdn.com/tps/TB1FG50KFXXXXXfXVXXXXXXXXXX-200-200.png" : "https://gw.alicdn.com/tps/TB1UmvYKFXXXXbGXXXXXXXXXXXX-200-200.png",
                        onClick: function(t) {
                            e.showGuide()
                        }
                    })), React.createElement("span", {
                        ...
                        className: "wf-icon",
                        src: "https://gw.alicdn.com/tps/TB1R0aRKFXXXXXPaXXXXXXXXXXX-200-200.png",
                        onClick: function(t) {
                            e.showGuide()
                        }
                    })), React.createElement("span", {
                        ...
                        className: "wf-icon",
                        src: "https://gw.alicdn.com/tps/TB1Fq6gKFXXXXXEXXXXXXXXXXXX-200-200.png",
                        onClick: function(t) {
                            e.showGuide()
                        }
                    })), React.createElement("span", {
                        ...
                        type: "radio",
                        name: "dateformatPush",
                        defaultChecked: this.getPushProps().attendanceRule == h,
                        value: "",
                        onChange: function(t) {
                            var n = e.getPushProps();
                        ...
                        type: "radio",
                        name: "dateformatPush",
                        defaultChecked: this.getPushProps().attendanceRule == v,
                        ...
                        type: "radio",
                        name: "dateformatPush",
                        defaultChecked: this.getPushProps().attendanceRule == g,
                        value: "yyyy-MM-dd HH:mm",
                        onChange: function(t) {
                            var n = e.getPushProps();
        ...
        var T = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = this.props.component.inTableField() && !this.props.component.getProp("stat"),
                        n = !t && "1" != this.props.component.getProp("notUpper");
                    return React.createElement("div", {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        type: "checkbox",
                        value: "1",
                        defaultChecked: this.props.component.getProp("important"),
                        onChange: function(t) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        defaultChecked: "yyyy-MM-dd HH:mm" === this.props.component.getProp("format"),
                        value: "yyyy-MM-dd HH:mm"
                    }), React.createElement("span", {
                        className: "verticalmiddle"
                        ...
                        defaultChecked: "yyyy-MM-dd" === this.props.component.getProp("format"),
                        value: "yyyy-MM-dd"
                    }), React.createElement("span", {
                        className: "verticalmiddle"
                    }, "年-月-日")))
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = "",
                        n = "",
                        o = "最多" + f["default"].LABEL_WORD_LIMIT + "个字",
                        a = "最多" + f["default"].LABEL_WORD_LIMIT + "个字",
                        r = this.props.component.getProp("label") || [];
                    ...
                    var s = function() {
                        var t = e.refs.startLabel.getDOMNode().value,
                            n = e.refs.endLabel.getDOMNode().value,
                            o = [t, n];
        ...
        var I = function(e) {
            ...
            return a(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = "",
                        n = "最多" + f["default"].ACTION_WORD_LIMIT + "个字";
                    return "toolong" === this.state.validstatus && (t = "error-toolong"), React.createElement("div", {
                        className: "wf-field wf-setting-placeholder"
                    }, React.createElement("div", {
                        className: "fieldname"
                        ...
                        type: "text",
                        className: t,
                        defaultValue: this.props.component.getProp("actionName"),
                        onChange: function(t) {
        ...
        var D = function(e) {
                ...
                return a(t, e), l(t, [{
                    ...
                    value: function() {
                        ...
                        return this.state.conflict && (t = "error-warn"), React.createElement("div", {
                            ...
                            type: "text",
                            className: t,
                            defaultValue: this.option.getValue(),
                            maxLength: 20,
                            onChange: function(t) {
            ...
            M = function(e) {
                function t(e, n) {
                    r(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this.options = e, this.value = n, this.id = parseInt(+new Date * Math.random()).toString(36).toUpperCase()
                }
                return a(t, e), l(t, [{
                    key: "getId",
                    value: function() {
            ...
            j = function(e) {
                ...
                return a(t, e), l(t, [{
                    key: "render",
                    value: function() {
                        var e = this.state.conflict ? "选项重复" : "最多" + f["default"].MAX_OPTIONS + "项，每项最多20个字",
                            t = this.props.component,
                            n = "";
                        this.state.length <= 1 ? n = "limitdel" : this.state.length >= f["default"].MAX_OPTIONS && (n = "limitadd");
                        var o = t.inTableField(),
                            a = 1 === t.isForCondition() && !o;
                        return React.createElement("div", {
