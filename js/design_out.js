...
key:"valid",value:function()
{
for(var e=this.validators,t=void 0,n=0,o=e.length;o>n;n++)if(t=e[n],t.validator.call(this,this.getProp(t.prop))===!0)return{msg:t.msg,component:this};
return null
}
}
,
...
{
return{
placeholder:"请选择",options:["选项1","选项2","选项3"]
}
}
}
,
...
,
{
  ...
  {
    return{
      placeholder:"请选择",format:"yyyy-MM-dd",unit:"天"
    }
  }
}
,
